<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Servicios.aspx.vb" Inherits="Servicios" MasterPageFile="~/MasterPageCuenza.Master" %>
                    ...
                    <tr>
                        <td style="padding-left:5px; width:265px; background-image: url('/Imagenes/Fondo_Titulos_Menus_04.png'); background-repeat: no-repeat; ">
                            <asp:Label ID="Label3" runat="server" Font-Names="Arial" Font-Size="Large" 
                                ForeColor="White" Text="Servicios"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style11">
                            <telerik:RadToolBar ID="RadToolBarActualizar" runat="server" Skin="Sunset">
                                ...
                                <Items>
                                    <telerik:RadToolBarButton runat="server" Text="Agregar" ToolTip="Agregar servicio nuevo">
                                    </telerik:RadToolBarButton>
                                    <telerik:RadToolBarButton runat="server" Text="Modificar" ToolTip="Modificar servicio seleccionado">
                                    </telerik:RadToolBarButton>
                                    <telerik:RadToolBarButton runat="server" Text="Aplicar Baja" ToolTip="Aplicar baja al servicio seleccionado">
                                    </telerik:RadToolBarButton>
                                </Items>
                            </telerik:RadToolBar>
                        </td>
                        ...
                        <telerik:RadGrid ID="RadGrid1" 
                            ...
                            <MasterTableView 
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Clave"             UniqueName="id_servicio"     DataField="id_servicio"     HeaderStyle-Width="100px" FilterControlWidth="60px" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Nombre"            UniqueName="nombre_servicio" DataField="nombre_servicio" HeaderStyle-Width="400px" FilterControlWidth="360px" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Línea de servicio" UniqueName="nombre_linea"    DataField="nombre_linea"    HeaderStyle-Width="300px" FilterControlWidth="260px" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                </Columns>
                               <EditFormSettings>
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT LineasServicio.nombre_linea, ss = REPLACE(REPLACE(Servicios.ss,'0','Baja'),'1','Activo'), Servicios.id_servicio, Servicios.nombre_servicio 
                                   FROM Servicios 
                                   INNER JOIN LineasServicio ON LineasServicio.id_linea_servicio = Servicios.id_linea_servicio 
                                   WHERE Servicios.id_servicio > 0 
                                   ORDER BY Servicios.id_linea_servicio, Servicios.id_servicio">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
