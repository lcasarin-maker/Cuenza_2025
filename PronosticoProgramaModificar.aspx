<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PronosticoProgramaModificar.aspx.vb" Inherits="PronosticoProgramaModificar" MasterPageFile="~/MasterPageCuenza.Master"%>
                    ...
                    <tr>
                        <td style="padding-left:5px; width:265px; background-image: url('/Imagenes/Fondo_Titulos_Menus_04.png'); background-repeat: no-repeat; ">
                            <asp:Label ID="LabelTitulo" runat="server" Font-Names="Arial" Font-Size="Large" 
                                ForeColor="White" Text="Modificar Pronóstico"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style5">
                            <telerik:RadToolBar ID="RadToolBarActualizar" runat="server" Skin="Sunset" TabIndex="24">
                                ...
                                <Items>
                                    <telerik:RadToolBarButton runat="server" Text="Enviar" ToolTip="Grabar cambios del registro">
                                    </telerik:RadToolBarButton>
                                    <telerik:RadToolBarButton runat="server" Text="Cancelar" ToolTip="Cancelar los cambios del registro">
                                    </telerik:RadToolBarButton>
                                </Items>
                            </telerik:RadToolBar>
                        </td>
                                    ...
                                    <td style="background-color:#e1e1e1;">
                                        <table cellpadding="0" cellspacing="0" class="auto-style1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style9">
                                                    <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                        <tr>
                                                            <td style="width:50%;">
                                                                <telerik:RadNumericTextBox ID="RadNumericTextBoxClave" Runat="server" ReadOnly="True" Width="100px">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <telerik:RadComboBox ID="RadComboBoxStatus" Runat="server" Width="98%" Skin="Default" AutoPostBack="True" TabIndex="14" Enabled="False"></telerik:RadComboBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style8">
                                    ...
                                    <td style="background-color:#e1e1e1;">
                                        <table cellpadding="0" cellspacing="0" class="auto-style1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style15">
                                                    <telerik:RadTextBox ID="RadNumericTextBoxImportePagoLetra" Runat="server" Width="94%" TabIndex="21"></telerik:RadTextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                        ...
                                                        <telerik:RadPane ID="gridPane" runat="server" Height="200px" Width="100%" Scrolling="None">
                                                            <telerik:RadGrid ID="RadGridPagos" runat="server" CellSpacing="0" GridLines="None" Skin="Sunset" Height="200px" Width="100%" AutoGenerateColumns="False">
                                                                ...
                                                                <MasterTableView NoDetailRecordsText="No hay registros que mostrar." NoMasterRecordsText="No hay registros que mostrar.">
                                                                    ...
                                                                    <Columns>
                                                                        <telerik:GridBoundColumn    UniqueName="tipo_factura"    DataField="tipo_factura"    HeaderText="Tipo de factura"      HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="no_pago"         DataField="no_pago"         HeaderText="Nó. de pago"          HeaderStyle-Width="80px"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="folio_factura"   DataField="folio_factura"   HeaderText="Folio de factura"     HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="fecha_fact"      DataField="fecha_fact"      HeaderText="Fecha de facturación" HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="fecha_pago"      DataField="fecha_pago"      HeaderText="Fecha de pago"        HeaderStyle-Width="90px"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="concepto"        DataField="concepto"        HeaderText="Concepto"             HeaderStyle-Width="500px" HeaderStyle-HorizontalAlign="Center" ></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="importe"         DataField="importe"         HeaderText="Importe"              HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:#,##0.00}"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn    UniqueName="importe_letra"   DataField="importe_letra"   HeaderText="Importe en letra"     HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Center" ></telerik:GridBoundColumn>
                                                                    </Columns>
                                                                    <EditFormSettings>
