<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LineasServicio.aspx.vb" Inherits="LineasServicio" MasterPageFile="~/MasterPageCuenza.Master" %>
                    ...
                    <tr>
                        <td style="padding-left:5px; width:265px; background-image: url('/Imagenes/Fondo_Titulos_Menus_04.png'); background-repeat: no-repeat; ">
                            <asp:Label ID="Label3" runat="server" Font-Names="Arial" Font-Size="Large" 
                                ForeColor="White" Text="Líneas de Servicio"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style11">
                            <telerik:RadToolBar ID="RadToolBarActualizar" runat="server" Skin="Sunset">
                                ...
                                <Items>
                                    <telerik:RadToolBarButton runat="server" Text="Agregar" ToolTip="Agregar línea de servicio nueva">
                                    </telerik:RadToolBarButton>
                                    <telerik:RadToolBarButton runat="server" Text="Modificar" ToolTip="Modificar línea de servicio seleccionada">
                                    </telerik:RadToolBarButton>
                                    <telerik:RadToolBarButton runat="server" Text="Aplicar Baja" ToolTip="Aplicar baja a la línea de servicio seleccionada">
                                    </telerik:RadToolBarButton>
                                </Items>
                            </telerik:RadToolBar>
                        </td>
                ...
                <telerik:RadSplitter ID="RadSplitter1" Height="600px" Width="1000px" runat="server" Orientation="Horizontal">
                    <telerik:RadPane ID="gridPane" runat="server" Height="600px" Scrolling="None">
                        <telerik:RadGrid ID="RadGrid1" 
                            ...
                            <MasterTableView 
                                DataKeyNames="id_linea_servicio"
                                TableLayout="Fixed" 
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Clave"   UniqueName="id_linea_servicio" DataField="id_linea_servicio" HeaderStyle-Width="100px" FilterControlWidth="60px" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Nombre"  UniqueName="nombre_linea"      DataField="nombre_linea"      HeaderStyle-Width="200px" FilterControlWidth="160px" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Socio"   UniqueName="socio"             DataField="socio"             HeaderStyle-Width="200px" FilterControlWidth="160px" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT ss = REPLACE(REPLACE(ss,'0','Baja'),'1','Activo'), id_linea_servicio, nombre_linea, socio, gerente FROM LineasServicio WHERE id_linea_servicio > 0 ORDER BY id_linea_servicio">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
