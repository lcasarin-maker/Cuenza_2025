<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PronosticoProgramaAutorizar.aspx.vb" Inherits="PronosticoProgramaAutorizar" MasterPageFile="~/MasterPageCuenza.Master"%>
                    ...
                    <tr>
                        <td style="padding-left:5px; width:265px; background-image: url('/Imagenes/Fondo_Titulos_Menus_04.png'); background-repeat: no-repeat; ">
                            <asp:Label ID="LabelTitulo" runat="server" Font-Names="Arial" Font-Size="Large" 
                                ForeColor="White" Text="Autorizar Pronóstico"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style5">
                            <telerik:RadToolBar ID="RadToolBarActualizar" runat="server" Skin="Sunset" TabIndex="24">
                                ...
                                <Items>
                                    <telerik:RadToolBarButton runat="server" Text="Autorizar" ToolTip="Autorizar el registro">
                                    </telerik:RadToolBarButton>
                                    <telerik:RadToolBarButton runat="server" Text="Rechazar" ToolTip="Rechazar el registro">
                                    </telerik:RadToolBarButton>
                                </Items>
                            </telerik:RadToolBar>
                        </td>
                                    ...
                                    <td style="background-color:#e1e1e1;">
                                        <table cellpadding="0" cellspacing="0" class="auto-style1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style11">
                                                    <telerik:RadTextBox ID="RadTextBoxEspecificaciones" Runat="server" Width="98%" Height="50px" TextMode="MultiLine" Skin="Sunset" TabIndex="16" Enabled="False">
                                                        <DisabledStyle BackColor="#F2F1F1" />
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>
