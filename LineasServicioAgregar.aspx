<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LineasServicioAgregar.aspx.vb" Inherits="LineasServicioAgregar" MasterPageFile="~/MasterPageCuenza.Master" %>
                    ...
                    <tr>
                        <td style="padding-left:5px; width:265px; background-image: url('/Imagenes/Fondo_Titulos_Menus_04.png'); background-repeat: no-repeat; ">
                            <asp:Label ID="LabelTitulo" runat="server" Font-Names="Arial" Font-Size="Large" 
                                ForeColor="White" Text="Agregar Línea de Servicio"></asp:Label>
                        </td>
                            ...
                            <table cellpadding="0" cellspacing="0" class="auto-style1" style="border: 1px solid #AAAAAA">
                                <tr>
                                    <td style="height:25px; padding-left:7px; background-image: url('/Imagenes/FondoTitulos13.png'); background-repeat: repeat-x;">
                                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="White" Text="Datos de la Línea de Servicio"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background-color:#e1e1e1;">
                                        <table cellpadding="0" cellspacing="0" class="auto-style1">
                                            ...
                                            <tr>
                                                <td class="auto-style8">
                                                    <asp:Label ID="Label14" runat="server" Font-Names="Arial Narrow" Font-Size="Small" Text="Socio"></asp:Label>
                                                </td>
                                                <td class="auto-style9">
                                                    <telerik:RadTextBox ID="RadTextBoxSocio" Runat="server" Width="100%" TabIndex="13" MaxLength="50"></telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style8">
                                                    <asp:Label ID="Label15" runat="server" Font-Names="Arial Narrow" Font-Size="Small" Text="Gerente"></asp:Label>
                                                </td>
                                                <td class="auto-style9">
                                                    <telerik:RadTextBox ID="RadTextBoxGerente" Runat="server" Width="100%" TabIndex="13" MaxLength="50"></telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style8">&nbsp;</td>
                    ...
                    <AjaxSettings>
                        <telerik:AjaxSetting AjaxControlID="RadToolBarActualizar">
                            <updatedcontrols>
                                ...
                                <telerik:AjaxUpdatedControl ControlID="RadTextBoxSocio" />
                                <telerik:AjaxUpdatedControl ControlID="RadTextBoxGerente" />
                            </updatedcontrols>
                        </telerik:AjaxSetting>
                    </AjaxSettings>                                
